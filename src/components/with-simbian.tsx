    ...
    >
      ...
      <div className="container mx-auto px-4 pt-24 pb-12 relative z-10">
        <div className="flex flex-col md:flex-row items-start justify-between mt-12">
          ...
          <div className="w-full md:w-1/2 md:mt-[180px]">
                ...
                <div className="flex flex-col space-y-12">
                  {steps.map((step, index) => (
                    <div className=" flex justify-end items-center">
                      {index == 0 ? (
                        <motion.div
                          className=" top-1/2 -translate-y-1/2 hidden md:flex flex-row items-center w-1/3"
                          initial={{ opacity: 0, y: 20 }}
                          animate={{ opacity: 1, y: 0 }}
                          exit={{ opacity: 0, y: -20 }}
                          transition={{ duration: 0.5 }}
                        >
                          <div className="w-3 h-3 border-l-2 border-b-2 border-green-400 transform rotate-45 -ml-1"></div>
                          <div className="w-32 h-0.5 bg-green-400"></div>
